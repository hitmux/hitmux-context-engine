...
The `@hitmux/hce` CLI package and the original MCP package `@hitmux/hitmux-context-engine-mcp` start the same server.
...
- `@hitmux/hce`: npm package alias for the MCP server.
